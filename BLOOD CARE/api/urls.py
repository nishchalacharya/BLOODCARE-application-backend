...
from .views import UserRegistrationView, UserLoginView, upload_document,UserProfileView, UserChangePasswordView, UserList, UserDetail, SendPasswordResetEmailView, UserPasswordResetView
